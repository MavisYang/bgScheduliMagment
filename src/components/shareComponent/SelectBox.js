...
export default class SelectBox extends Component{
    ...
    render(){
        ...
        let {selectLabel,selectOption,paramName,paramDefault,paramValue,width,all,verify,disable} = this.props
        ...
        return(
            <div className='selectWrapper' onBlur={this.hideOption.bind(this)} tabIndex={1}>
                ...
                <div className="selectBox" style = {widthStyle}>
                    <div className="selectOption" id={id} onClick={this.showMoreOption.bind(this)} style={Object.assign({},{border:!verify?'1px solid red': showOption?"1px solid transparent":"1px solid transparent"},widthStyle)}>
                    ...
                    <div className="optionUl" style={Object.assign({},{display:showOption?"block":"none",transition:'all .4s'},widthStyle)}>
                        <ul>
                            <li style={{display:all?'block':'none'}}
                                ...
                                onClick={this.selectedOption.bind(this,null,'全部',paramName,null)}>全部</li>
